...
#define   PHY_DLL_RECALIB_TRIM_MASK	MASK(PHY_SLV_DLY_WIDTH, 0)
#define   PHY_DLL_RECALIB_INCR		BIT(27)
#define PHY_DLL_ADRCTRL			(0x4A << (PHY_REG_SHIFT))
#define   PHY_DLL_ADRCTRL_TRIM_MASK	MASK(PHY_SLV_DLY_WIDTH, 0)
#define   PHY_DLL_ADRCTRL_INCR		BIT(9)
#define   PHY_DLL_ADRCTRL_MDL_SHIFT	24
#define   PHY_DLL_ADRCTRL_MDL_MASK	MASK(PHY_MAS_DLY_WIDTH, \
...
#define   PHY_DLL_TRIM_CLK_MASK		MASK(PHY_SLV_DLY_WIDTH + 1, 0)
